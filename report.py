...
class ReportClass:
    def __init__(self,root):
        ...
        btn_searh=Button(self.root,text="Search",font=("goudy old style",20,"bold"),bg="#2566ba",fg="white",cursor="hand2",command=self.search).place(x=690,y=100,width=120,height=35)
        btn_clear=Button(self.root,text="Clear",font=("goudy old style",20,"bold"),bg="#136150",fg="white",cursor="hand2",command=self.clear).place(x=830,y=100,width=120,height=35)
        ...
        lbl_full=Label(self.root,text="Full Marks.",font=("goudy old style",20,"bold"),bg="white",bd=2,relief=GROOVE).place(x=800,y=230,width=150,height=50)
        ...
        btn_delete=Button(self.root,text="Delete",font=("goudy old style",20,"bold"),bg="#D64D74",fg="white",cursor="hand2",command=self.delete).place(x=500,y=350,width=150,height=35)
          ...
          if self.var_id=="":
              ...
              if row ==None:
                  ...
                  if op==True:
                      ...
                      con.commit()
                      messagebox.showinfo("Delete","result deleted Sucessfullly",parent=self.root)
                      self.clear()
